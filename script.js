...
const playerScoreElemet = document.getElementById('playerScore');
const playerChoiceElement = document.getElementById('playerChoice');
const computerScoreElemet = document.getElementById('computerScore');
...
function resetAll() {
  ...
  playerScoreElemet.textContent = playerScoreNumber;
  computerScoreElemet.textContent = computerScoreNumber;
